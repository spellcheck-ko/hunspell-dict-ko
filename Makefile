...
DICT_DATA = dict-ko-builtins.json dict-ko-galkwi-ccby.json dict-ko-galkwi-mplgpllgpl.json
...
BIN_DISTCONTENT = LICENSE LICENSE.CC-BY LICENSE.GPL LICENSE.LGPL LICENSE.MPL $(AFFIX) $(DICT)
